...
| [Partition the Support, Reconstruct the Residual: Training-Free Sparse Attention for Video Generation and World Models](https://arxiv.org/abs/2608.18484) | Combines response-coupled block partitioning with probe-fitted residual reconstruction across video generators and world models. | arXiv 2026.08 | video diffusion, world models, training-free, block-sparse |
